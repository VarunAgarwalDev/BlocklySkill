...
# The skill builder object helps in adding components responsible for handling
# input requests and generating custom responses for your skill.

sb = SkillBuilder()

class LaunchRequestHandler(AbstractRequestHandler):
    # Whether or not handler can respond
...
# Catch all handler, will log bugs
